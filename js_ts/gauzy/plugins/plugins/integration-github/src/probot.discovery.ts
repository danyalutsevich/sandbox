...
import { v4 } from 'uuid';
import * as probotTypesJs from './probot.types.js';
import { createProbot, createSmee } from './probot.helpers.js';
...
export class ProbotDiscovery implements OnModuleInit, OnApplicationBootstrap, OnApplicationShutdown {
	...
	constructor(
		...
		@Inject(probotTypesJs.ModuleProviders.ProbotConfig)
		private readonly config: probotTypesJs.ProbotConfig
	) {
