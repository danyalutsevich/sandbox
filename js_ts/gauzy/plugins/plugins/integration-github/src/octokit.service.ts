...
import { parseConfig } from './probot.helpers.js';
import * as probotTypes from './probot.types.js';
...
export class OctokitService {
	...
	constructor(
		@Inject(probotTypes.ModuleProviders.ProbotConfig)
		private readonly config: probotTypes.ProbotConfig
	) {
		/** */
		try {
