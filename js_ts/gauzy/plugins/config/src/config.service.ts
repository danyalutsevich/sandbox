...
export class ConfigService {
	...
	get dbConnectionOptions(): Readonly<TypeOrmModuleOptions> {
		return this.config.dbConnectionOptions as unknown as Readonly<TypeOrmModuleOptions>;
	}
	...
	get dbMikroOrmConnectionOptions(): Readonly<MikroOrmModuleOptions> {
		return this.config.dbMikroOrmConnectionOptions as unknown as Readonly<MikroOrmModuleOptions>;
	}
