...
exports.keysToWrapSecrets = exports.sensitiveSecretKeys = void 0;
 ...
 */
function keysToWrapSecrets(keysToWrap, secrets, percentage = 35, character = '*') {
    // Checks if a value is an object
    if ((0, index_1.isObject)(secrets) && Array.isArray(keysToWrap)) {
        // Checks if a value is not empty
        for (const key of keysToWrap) {
            if ((0, index_1.isNotEmpty)(secrets[key])) {
