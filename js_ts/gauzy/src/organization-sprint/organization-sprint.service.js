...
let OrganizationSprintService = exports.OrganizationSprintService = class OrganizationSprintService extends crud_1.TenantAwareCrudService {
    constructor(typeOrmOrganizationSprintRepository, mikroOrmOrganizationSprintRepository) {
        super(typeOrmOrganizationSprintRepository, mikroOrmOrganizationSprintRepository);
    }
};
exports.OrganizationSprintService = OrganizationSprintService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(organization_sprint_entity_1.OrganizationSprint)),
    __metadata("design:paramtypes", [type_orm_organization_sprint_repository_1.TypeOrmOrganizationSprintRepository,
