...
@Permissions(dist.PermissionsEnum.INTEGRATION_VIEW)
@Controller()
export class UpworkController {
	...
	async getAccessTokenSecretPair(
		@Body() config: dist.IUpworkClientSecretPair,
		@Param('organizationId', UUIDValidationPipe) organizationId: string
	): Promise<dist.IAccessTokenSecretPair> {
	...
	async getAccessToken(
		@Body() accessTokenDto: dist.IAccessTokenDto,
		@Param('organizationId', UUIDValidationPipe) organizationId: string
	): Promise<dist.IAccessToken> {
	...
	@Get('work-diary')
	async getWorkDiary(
		@Query('data', ParseJsonPipe) data: dist.IGetWorkDiaryDto
	): Promise<any> {
	...
	async getContracts(
		@Query('data', ParseJsonPipe) data: dist.IGetContractsDto
	): Promise<dist.IEngagement[]> {
