...
import { ISMTPConfig, isEmpty } from '../../plugins/common/dist/index';
import { IBasePerTenantAndOrganizationEntityModel, IVerifySMTPTransport } from '../../plugins/contracts/dist/index';
