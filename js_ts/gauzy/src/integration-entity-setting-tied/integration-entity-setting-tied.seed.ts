...
import { IIntegrationEntitySettingTied, IntegrationEntity, ITenant } from  '../../plugins/contracts/dist/index';
import { PROJECT_TIED_ENTITIES } from  '../../plugins/plugins/integration-hubstaff';
