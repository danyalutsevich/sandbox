...
import { DEFAULT_ENTITY_SETTINGS } from  '../../plugins/plugins/integration-hubstaff/dist/index';
import { IIntegrationEntitySetting, IIntegrationEntitySettingTied, ITenant } from  '../../plugins/contracts/dist/index';
