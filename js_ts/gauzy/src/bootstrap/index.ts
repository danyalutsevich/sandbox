...
import { getConfig, setConfig, environment as env } from'../../plugins/config/dist/index'; 
import { getEntitiesFromPlugins, getPluginConfigurations, getSubscribersFromPlugins } from '../../plugins/plugin/dist/index'; 
