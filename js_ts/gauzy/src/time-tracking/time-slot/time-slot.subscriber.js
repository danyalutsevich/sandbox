...
let TimeSlotSubscriber = exports.TimeSlotSubscriber = class TimeSlotSubscriber extends base_entity_event_subscriber_1.BaseEntityEventSubscriber {
    /**
    ...
    */
    ...
    async afterEntityLoad(entity) {
        try {
            ...
            if ('startedAt' in entity) {
                entity.stoppedAt = (0, moment_1.default)(entity.startedAt).add(10, 'minutes').toDate();
            }
    ...
    async afterEntityDelete(entity) {
        try {
            ...
            if (entityId && Array.isArray(screenshots) && (0, index_1.isNotEmpty)(screenshots)) {
...
exports.TimeSlotSubscriber = TimeSlotSubscriber = __decorate([
