 ...
 */
export declare class EmployeeRecurringExpenseByMonthHandler extends FindRecurringExpenseByMonthHandler<EmployeeRecurringExpense> implements IQueryHandler<EmployeeRecurringExpenseByMonthQuery> {
    ...
    execute(command: EmployeeRecurringExpenseByMonthQuery): Promise<IPagination<EmployeeRecurringExpense>>;
}
