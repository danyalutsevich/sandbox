...
exports.generateInvoicePdfDefinition = void 0;
const index_1 = require("../../plugins/contracts/dist/index");
async function generateInvoicePdfDefinition(invoice, organization, organizationContact, translatedText, language) {
    const body = [];
    ...
    if (invoice.invoiceType === index_1.InvoiceTypeEnum.DETAILED_ITEMS) {
        widths = ['25%', '25%', '25%', '25%'];
    }
    else {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        text: `${invoice.isEstimate
                            ...
                            : translatedText.invoice} ${translatedText.number}: ${invoice.invoiceNumber}`
                    }
                ]
            },
            ' ',
                        ...
                        text: [
                            {
                                ...
                                text: `${invoice.isEstimate
                                    ? translatedText.estimate
                                    : translatedText.invoice} ${translatedText.date}: `
                            },
...
exports.generateInvoicePdfDefinition = generateInvoicePdfDefinition;
//# sourceMappingURL=generate-invoice-pdf.js.map