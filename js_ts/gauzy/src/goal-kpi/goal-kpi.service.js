...
let GoalKpiService = exports.GoalKpiService = class GoalKpiService extends crud_1.TenantAwareCrudService {
    constructor(typeOrmGoalKPIRepository, mikroOrmGoalKPIRepository) {
        super(typeOrmGoalKPIRepository, mikroOrmGoalKPIRepository);
    }
};
exports.GoalKpiService = GoalKpiService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(goal_kpi_entity_1.GoalKPI)),
    __metadata("design:paramtypes", [type_orm_goal_kpi_repository_1.TypeOrmGoalKPIRepository,
