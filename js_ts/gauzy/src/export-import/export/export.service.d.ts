...
export declare class ExportService implements OnModuleInit {
    ...
    private typeOrmCountryRepository;
    private typeOrmCurrencyRepository;
    ...
    private typeOrmTenantRepository;
