...
import { FileStorageOption, FileStorageProvider, FileSystem, UploadedFile } from '../../../../plugins/contracts';
export declare abstract class Provider<T> {
    abstract instance: any | undefined;
    abstract readonly name: FileStorageProvider;
     ...
     */
    mapUploadedFile(uploadedFile: UploadedFile): Promise<UploadedFile>;
}
