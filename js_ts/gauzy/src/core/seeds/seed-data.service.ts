...
import { environment as env, ConfigService, DatabaseTypeEnum } from '../../../plugins/config/dist/index'; 
import {
	IEmployee,
	IOrganization,
...
} from '../../../plugins/plugin/dist/index'; 
...
import { IDBConnectionOptions } from '../../../plugins/common/dist';
...
export class SeedDataService {
	...
	private async cleanAll(entities: Array<any>) {
		try {
			...
			const databaseType = getDBType(this.configService.dbConnectionOptions as IDBConnectionOptions);
